'''
A lightweight helper script that encapsulates weather data access — either to 
retrieve existing processed data or run the data pipeline end-to-end if not found.
Main Role: Interface/bridge between raw weather data and model-ready weather features.
'''
