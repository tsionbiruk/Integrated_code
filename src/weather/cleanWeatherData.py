'''
Processes the raw .grib2 weather files produced by dataCollectionScript.py, extracting
 the relevant data and formatting it into clean numerical features usable by forecasting models.
 Main Role: Feature engineering and transformation from weather data.
'''
